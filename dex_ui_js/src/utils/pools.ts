...
export function getLpMintByTokenMintAddresses(
  ...
  const pool = LIQUIDITY_POOLS.find(
    pool =>
      (pool.coin.mintAddress === mintA && pool.pc.mintAddress === mintB) ||
      (pool.coin.mintAddress === mintB && pool.pc.mintAddress === mintA)
  )
  if (pool) {
...
export function getPoolByLpMintAddress(lpMintAddress: string): LiquidityPoolInfo | null {
  return LIQUIDITY_POOLS.find(pool => pool.lp.mintAddress === lpMintAddress) || null
}
...
export const LIQUIDITY_POOLS: LiquidityPoolInfo[] = [
  ...
  },
  {
    ...
    ammTargetOrders: 'DDcoNXXt8FVhtBscbgrvXsSDLNNKRs1v43QqGcGAFspq',
    // no need
    ammQuantities: NATIVE_SOL.mintAddress,
    ...
    poolWithdrawQueue: '79n1q4jP7SkNZ97PNMG7p2xa4hh7sUdtiztJynrSEmZk',
    poolTempLpTokenAccount: '7xPfrhG8eaV9Vr66dy2wEchuXvU3jQFNYtQ5Zie1AEAo',
    serumProgramId: SERUM_PROGRAM_ID_V3,
    serumMarket: 'HuFKVQNyB177c9DiocQksYzBCtHMRUP5bBXZJzuLvYQm',
    serumBids: 'd3LpprS4kt81QT7hozsMxQJ4EHRT66esu7HRBvnjXHk',
    serumAsks: 'Ax2tmh1snhvcQEV5tE2uyCgn5Ly81JJpkBFUnaW9JzPf',
    serumEventQueue: 'AwqanJUwreJjzqQnzwfJ2Gt7itdVLfb8AagdSaYePAh3',
    serumCoinVaultAccount: '2PwrP5xB816jePXPpwXFFqpLf73AHm7CrzJDzVovwJAG',
    serumPcVaultAccount: 'FHCBp7UvkD2ppoHAec5A8VLYobSqxFmRvrKWB31CjcEY',
  ...
  },
  {
    ...
    version: 4,
    programId: LIQUIDITY_POOL_PROGRAM_ID_V4,
    ammId: 'BPg6Tp8ynURqoxdCPVtZJM1K9MW7PSTxr5KAvDaFJV69',
    ammAuthority: '5Q544fKrFoe6tsEbD7S8EmxGTJYAKtTVhAW5Q5pge4j1',
    ammOpenOrders: 'BrgX16ooPYhBsFAC12PmiMRBhCcArgzTgVM6wPk1iXkv',
    ammTargetOrders: '2Rrsg8DJUf7p1p8ARsJ9mMW19DXuuZ92VfQKj25KMJT5',
    // no need
    ammQuantities: NATIVE_SOL.mintAddress,
    poolCoinTokenAccount: 'AV3J3UDeT5nCTrMLGu9XvHcuGV22Dzt3A5RZ4AfmjZbJ',
    poolPcTokenAccount: '7F6QN5fbpSmvBSPNo3e1Ek3duxokGhskRksfNPZURUuE',
    poolWithdrawQueue: '5Vmv7dEuV5YHJxJ9zmMoyzTNYutvCHaDeLL1M8ABgoS2',
    poolTempLpTokenAccount: 'AK2fUTT5DQFevaiFowinhEcKdjCaqjuHTrWjbGUKvUtm',
    serumProgramId: SERUM_PROGRAM_ID_V3,
    serumMarket: 'EbtdM5qD52MBb8mKLXfFc2G8wpzP4mMhtsdAJzvZ9tfC',
    serumBids: '8ha4skhcohrda3bkQsjEcChuN6nYwawewBs7GWFHYXpo',
    serumAsks: 'DSFcaeqKgh9zMafAWbwpuvZsLoztxASdWNUn7csbjYrD',
    serumEventQueue: 'JDhTybaqoUATJ6JYCPsdyyQUzL5guN383cSkiinBAFmK',
    serumCoinVaultAccount: '6SusNVZk3Jx4FsganHrE6asqoRKvPJr8kFgVJU99S7gx',
    serumPcVaultAccount: 'DKHSzMBqonDh37ThvwZ68CWzPDjfPyYNX3tG4Zcxn89z',
    serumVaultSigner: 'BXxkijy8KdvQ47kdTYEsoFtHRibUyHEvsjp4aaV9nJnK',
    official: true
  },
  {
    name: 'FANT-USDC',
    coin: { ...TOKENS.FANT },
    pc: { ...TOKENS.USDC },
    lp: { ...LP_TOKENS['FANT-USDC-V4'] },

    version: 4,
    programId: LIQUIDITY_POOL_PROGRAM_ID_V4,
    ammId: 'ASZQnZRRDLF3Fzu8pjow8mWneBQakMNiVJUBgMLPpwhF',
    ammAuthority: '5Q544fKrFoe6tsEbD7S8EmxGTJYAKtTVhAW5Q5pge4j1',
    ammOpenOrders: 'HjJPj9WiVc5g4Z1VB8nJTtrTSow8agjiRYdCbNnGXeJM',
    ammTargetOrders: 'HN1iZ3qTCBCGujghEbKGWfynCFhBkthnU5gpEmuzNtw6',
    // no need
    ammQuantities: NATIVE_SOL.mintAddress,
    poolCoinTokenAccount: 'BCPrE8fB4HQW3gsFgecX2YpNrXYUpByErJ3xvXAEgfKC',
    poolPcTokenAccount: '5Y9FQtJtnNfPvo29q4UBGwUkVEYourFAJ9coSyqWK15r',
    poolWithdrawQueue: 'xDWSFcetrCJPP9aZzCScJ9RwGizHHMzLV12Y5GRzNuY',
    poolTempLpTokenAccount: 'BgNJ913fJKDnVxhq8bepK2gpDxM9L4aqoCa5psx7t3Mx',
    serumProgramId: SERUM_PROGRAM_ID_V3,
    serumMarket: '4rtLjEACKFbUxGB2zrWxNkRnCNbSr7ES1ZsXrTd6mhbr',
    serumBids: '7kewioJvrRoy6FnTGr7S63kW8W3cMzDhg7GrjSuUTKM5',
    serumAsks: 'C3VBBiAVH3h7HEUP4gNxMrptixiGgesLKcyoSDW1TjoQ',
    serumEventQueue: 'HfuH5L933CKevZ7XucsSkMMV8KcqN2Rf6na7qiStTZaz',
    serumCoinVaultAccount: 'Hgt55e2QadHXmef1Sp4Xvx6Lg7ss29nq63pk8PKSvsv3',
    serumPcVaultAccount: 'CBuPHevzRU9Jc244b1452dNDT99xLCjnASe8nUF1Vk56',
    serumVaultSigner: 'DyQcNBSVbxksfiHTd6Xe4JGjyoiSorUerVqqm2qjGAk5',
    official: true
  },
  {
    name: 'NOS-USDC',
    coin: { ...TOKENS.NOS },
    pc: { ...TOKENS.USDC },
    lp: { ...LP_TOKENS['NOS-USDC-V4'] },

    version: 4,
    programId: LIQUIDITY_POOL_PROGRAM_ID_V4,
    ammId: 'Cj7kD2VmzwSrwKBieuYYbjPEvr8gwhNi76KUESbGDNfF',
    ammAuthority: '5Q544fKrFoe6tsEbD7S8EmxGTJYAKtTVhAW5Q5pge4j1',
    ammOpenOrders: 'DEM1Zse8UWfKEk9dH1Jkjzepdb9DSaxMZ8uDe34rmbE5',
    ammTargetOrders: '2XNpMn3zB1jKKCHkchHUUk5A3DWGNi3wcCf54cqpj4g7',
    // no need
    ammQuantities: NATIVE_SOL.mintAddress,
    poolCoinTokenAccount: '9Gs4LvFZw18EBLrSmZbQBw4G2SpTu4bJRCWH1Dz33cUZ',
    poolPcTokenAccount: 'FqKU4BxbabPd1tcZAVVv8JkdUWmdz32CocRM856gA3Lw',
    poolWithdrawQueue: 'F6RxBH334HoBXEJUE9p31HNcBSxe8J2mnpkscan3KpHa',
    poolTempLpTokenAccount: '94nNYdTKstTkPkhBBCyEtHu3cALAq3FACC4DXLH7sXHx',
    serumProgramId: SERUM_PROGRAM_ID_V3,
    serumMarket: '8XaEfk3TURqgrJZvdJWrPLqyXSCmJ9MfSwZrkaYmsG7r',
    serumBids: 'Dce8vCTs8sqHR9phF6TPeeKKQ6qmJ7PhawiFkcATZPHF',
    serumAsks: 'BxoLDGQiBXyFuV9icqhHoXc3FrwF6mPvvKazkHfL9e1G',
    serumEventQueue: '6gEAWchqQiw96LFUw5awYN3svftvr1aWZvMa12ob6C1P',
  ...
  },
  {
    ...
    coin: { ...TOKENS.YAW },
    pc: { ...TOKENS.USDC },
    lp: { ...LP_TOKENS['YAW-USDC-V4'] },

    version: 4,
    programId: LIQUIDITY_POOL_PROGRAM_ID_V4,
    ammId: '2T4LusNHwsT15p3yrPSSL7tYw2fucQoag4HkejT1wiYw',
    ammAuthority: '5Q544fKrFoe6tsEbD7S8EmxGTJYAKtTVhAW5Q5pge4j1',
    ammOpenOrders: '7vYwREyvhGiCfjS78bNE3VDQSz4j1gvfa4NYJ7quiZG5',
    ammTargetOrders: 'EY4NCrDZAgnvDPuSVzZRaaWGNkaPEczTQ3F13oQVwup1',
    // no need
    ammQuantities: NATIVE_SOL.mintAddress,
    poolCoinTokenAccount: 'AruoX147o2RwMNXVJajZFnfdVAeF8PZc4PxRhn6CCzdz',
    poolPcTokenAccount: 'EAZ1pYH6QaVnQa5FjKApiNG6rgLZxqBf14PjESe9dLAy',
    poolWithdrawQueue: '9hWFEDG7k98TUWDHQdEsN4sL17XCBnfe7qn3hdUj33WU',
    poolTempLpTokenAccount: 'HSxp1453fiso6peygjTvVARw3gSsrtbBWMEKHT1yAfc9',
    serumProgramId: SERUM_PROGRAM_ID_V3,
    serumMarket: 'XSiwhjR4nQ9CenYXFN162Uk3ZR2njXCv5cvCsquyePL',
    serumBids: 'GP5XbF1kGeSQZD5t5dzNCAQnF5ePy4YysHj6jBJGqJ4A',
    serumAsks: 'Hd6S1Toi4c93Y3666P9ayqHjx5VzkUAR2R3dShxEQ7YX',
    serumEventQueue: 'ErYfT4r9rtoyUR5BczyXRpNfpDn5Q9Goh1P9T84AEXaD',
    serumCoinVaultAccount: '4MLmfc8PByw1gHU6XfWswZ93Hz6x4t8RxLTmroBqtBh2',
    serumPcVaultAccount: 'D65CQ5t7vCLWnW1AXQWfJgq2AT7JQwABsQk7zDMiPb6M',
    serumVaultSigner: 'AaxRLM4qhcpZXAKjiYMNW9Xii215qiVbxEZysNM9nNfe',
    official: true
  },
  {
    name: 'ZBC-USDC',
    ...
    ammTargetOrders: '9egU1WLbwmhqrPYm7xr8n6cXWiRv4Kmi2GWauWsZdbrW',
    // no need
    ammQuantities: NATIVE_SOL.mintAddress,
    ...
    poolWithdrawQueue: '6vYN1pybopcpfRLyqXcauBut6hQyDzTfHLu316aXW8HK',
    poolTempLpTokenAccount: '3wXGKiMFS268XUEuoEpvoFC24UG6FF7DbNspPCPN8jZG',
    serumProgramId: SERUM_PROGRAM_ID_V3,
    serumMarket: 'C3c2NZurMhwrgMAaUXewjDGTy5f93MvYbhYCYfXXmnZN',
    serumBids: 'HwETAvJHBVC7rRvt1QSwGqvejPiBNSC28SGDL8U8mS2f',
    serumAsks: 'pc5SRd3qRbAbmwKsNBjbZL3LbLjSanPExDyjRkkdgk4',
    serumEventQueue: 'CsVM1k36bfmgiuF7bKmpsMuaF2m4GPuuBNkoQoNDqXNS',
    serumCoinVaultAccount: 'ERMmp8KsdZYE5nQ8aN4ArVHR2QTXeHuHqazmJkLfb5NP',
    serumPcVaultAccount: '9G9Ur6KFmG1hce1pv8jMFD6Xu96tgN8iaJB6VBActSMz',
