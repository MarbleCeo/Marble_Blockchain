...
export const LP_TOKENS: { [key: string]: TokenInfo } = {}
...
export function getTokenBySymbol(symbol: string): TokenInfo | null {
  return Object.values(TOKENS).find(item => item.symbol === symbol) || null
}

export function getTokenByMintAddress(mintAddress: string): TokenInfo | null {
  return Object.values(TOKENS).find(item => item.mintAddress === mintAddress) || null 
}
...
export const TOKENS: Tokens = {
  ...
  prANA: {
    ...
    docs: {
      ...
      whitepaper: 'https://docs.nirvana.finance/mechanics/summary'
    },
    socials: {
